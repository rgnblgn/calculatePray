            ...
            >
                <View style={styles.content}>
                    ...
                    <View style={styles.actionButtons}>
                        <TouchableOpacity
                            style={[styles.actionButton, styles.languageButton, isDark && styles.languageButtonDark]}
                        ...
                        <TouchableOpacity
                            style={[styles.actionButton, styles.resetButton, isDark && styles.resetButtonDark]}
